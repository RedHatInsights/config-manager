// Package cloudconnector provides primitives to interact the openapi HTTP API.
//
...
type ClientWithResponsesInterface interface {
	// GetConnection request
	GetConnectionWithResponse(ctx context.Context) (*GetConnectionResponse, error)
	...
	// GetConnectionAccount request
	GetConnectionAccountWithResponse(ctx context.Context, account AccountID) (*GetConnectionAccountResponse, error)
...
func (c *ClientWithResponses) GetConnectionWithResponse(ctx context.Context) (*GetConnectionResponse, error) {
	rsp, err := c.GetConnection(ctx)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetConnectionAccountWithResponse(ctx context.Context, account AccountID) (*GetConnectionAccountResponse, error) {
	rsp, err := c.GetConnectionAccount(ctx, account)
	if err != nil {
		return nil, err
	}
