...
var DefaultConfig Config = Config{
	...
	CloudConnectorHost:      flagvar.URL{Value: url.MustParse("http://localhost:8080")},
	CloudConnectorPSK:       "",
	...
	DispatcherHost:          flagvar.URL{Value: url.MustParse("http://localhost:8000")},
	DispatcherPSK:           "",
	DispatcherTimeout:       10,
	InventoryHost:           flagvar.URL{Value: url.MustParse("http://localhost:8001")},
	InventoryTimeout:        10,
